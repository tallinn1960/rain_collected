...
#ifndef TRAP_SWIFT_SWIFT_H
#define TRAP_SWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="trap_swift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("trap_swift", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace trap_swift SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("trap_swift") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN uint64_t $s10trap_swift13rainCollectedys6UInt64VSPys5Int64VG_ADtF(int64_t const * _Nonnull heights, uint64_t count) SWIFT_NOEXCEPT SWIFT_CALL; // rainCollected(_:_:)
...
SWIFT_INLINE_THUNK uint64_t rainCollected(int64_t const * _Nonnull heights, uint64_t count) noexcept SWIFT_SYMBOL("s:10trap_swift13rainCollectedys6UInt64VSPys5Int64VG_ADtF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s10trap_swift13rainCollectedys6UInt64VSPys5Int64VG_ADtF(heights, count);
}


} // namespace trap_swift
