...
mod tests {
    ...
    fn calculate_execution_time() {
        ...
        println!("Execution time compute_rain_collected: {} microseconds", execution_time);
        ...
        println!("Execution time compute_rain_collected_parallel: {} microseconds", execution_time);
    }
